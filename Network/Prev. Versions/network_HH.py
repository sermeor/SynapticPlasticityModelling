...
def comp_model(t, y, N, NE):
	...
	p75NTR_bound = p75_NTR(y[10], pro_bdnf)  #Bound proBDNF and BDNF to p75NTR.
	...
	dy[10] = 0# *(1-y[10])
	dy[11:] = connectivity_update(y[11:], y[9], N, NE, y[5], Cao)
...
time = 1 / t_factor  # Time of simulation depending on t_factor.
